...
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.execute = function (date, animal_id, type) {
        return __awaiter(this, void 0, void 0, function () {
            var animal, appointment, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        animal = prisma_1.default.animal.findFirst({
                            where: {
                                id: animal_id,
                            },
                        });
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prisma_1.default.appointment.create({
                                data: {
                                    date: dayjs_1.default(date).toDate(),
                                    type: type,
                                    animal_id: animal_id,
                                },
                                include: {
