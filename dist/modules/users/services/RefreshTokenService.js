...
var RefreshTokenService = /** @class */ (function () {
    ...
    RefreshTokenService.prototype.execute = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, role, sub, user_id, userTokens, refresh_token_expires_date, refresh_token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = jsonwebtoken_1.verify(token, auth_1.default.secret_refresh_token), role = _a.role, sub = _a.sub;
                        user_id = sub;
                        return [4 /*yield*/, prisma_1.default.userToken.findFirst({
                                where: {
                                    user_id: user_id,
                                    refresh_token: token,
                                },
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prisma_1.default.userToken.delete({
                                where: {
                                    id: userTokens.id,
                                },
                            })];
